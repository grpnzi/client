  ...
  <div className="row featurette">
    ...
    <div className="col-md-6 mt-5 d-flex flex-wrap">
      {guides ? (
        guides.map((guide) => {
          return (
            <div key={guide.id} className="mb-4 col-md-4 col-lg-3" style={{ maxWidth: '250px', minWidth: '200px', margin: '0 15px' }}>
              <Card className="bg-dark text-white">
                <Card.Img
                  src={guide.img}
                  alt="Card image"
                  className="img-thumbnail img-fluid"
                  style={{ objectFit: 'cover', height: '250px', width: '100%', maxWidth: '100%' }} // Set maxWidth here
                />
                <div
