                    ...
                    <div className="d-inline-block align-top"> {/* Add this container */}
                        ...
                        <div className="d-flex justify-content-start">
                            {user ?
                                ...
                                :
                                <Link to="/login"><button className="btn-sm btn-dark rounded border border-warning mb-2"
                                    style={{ width: '130px', maxHeight: '30px', fontFamily: 'Share', fontSize: '14px' }}>Rate</button></Link>}
                        </div>
                    </div>
                </div>
                :
