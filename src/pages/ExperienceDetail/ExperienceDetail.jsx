...
function ExperienceDetail() {
    ...
    const location2 = 'ESP'
    const apiUrl = `http://localhost:5005/country/${location2}/${experienceId}`
    const apiUrlReviews = `http://localhost:5005/reviews/${experienceId}`
    ...
    console.log(expReviews);

    if (!experience || !expReviews) {
        return <p>Loading...</p>;
    }
